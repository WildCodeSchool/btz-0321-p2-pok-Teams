  ...
  return (
    <div className=" m-0 p-0">
      ...
      <div className=" flex justify-center bottom-14 py-52 pc:py-20">
        ...
        <button className="absolute z-50 top-1/2  bg-red-700 hover:bg-red-500 font-extrabold py-2 px-12 my-40 pc:w-1/4 pc:p-3 rounded-tl-3xl rounded-br-3xl rounded-tr-md rounded-bl-md .shadow-inner ">

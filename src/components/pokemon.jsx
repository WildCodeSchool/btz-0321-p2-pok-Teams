...
function Pokemon({ filter, url }) {
  ...
  return (
    <div className="flex flex-col align-center justify-center font-Quantico ">
      <div className="">
        <div className="bg-gray-50 w-40 border-2 border-teal-300 rounded-lg flex flex-col text-g text-center m-1.5 shadow-2xl mx-2 my-2 ">
          <div className="flex justify-around bg-teal-500 rounded-t-lg">
            <h2 className="text-xl text-gray-200">{pokemonData.name}</h2>
            <p className=" text-lg text-gray-200 "> {pokemonData.id}</p>
          </div>
